                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    ...
                    @csrf
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="{{ old('name') }}" type="text" id="title" name="name" class="block w-full  appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('name') border-red-500 @enderror" />
                            </div>
                            @error('name')
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="{{ old('price') }}" type="number" min="0.00" max="10000.00" step="0.01" id="price" name="price" class="block w-full  appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('price') border-red-500 @enderror" />
                            </div>
                            @error('price')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
